...
class Quat(object):
    ...
    * a 3x3 transform/rotation matrix
    ...
    def _set_q(self, q):
        ...
        """
        print('this is q passed to _set_q: '+str(q))
        q = np.array(q)
    ...
    # Currently this causes an error with initialization. commented out, is needed???
    ...
    def _get_dec(self):
        """Retrieve Dec term from equatorial system in degress"""
    ...
    def _quat2equatorial(self):
        ...
        # calculate directon cosine matrix elements from $quaternions
    ...
    def _quat2transform(self):
        ...
        (to be applied on the right side).
    ...
    def _equatorial2transform(self):
        ...
        # This is the transpose of the transformation matrix
    ...
    def _transform2quat(self):
        ...
        # ?? original code used backwards index ordering, so transpose may not be required??
